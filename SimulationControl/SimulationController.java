...
public class SimulationController {
    ...
    public SimulationController() {
    	...
    	Driver d1 = new AggressiveDriver(new Vehicle(new Point(0,0), 0, this.road, 30, 50, 1, "pink-sports-car.png"), "Rob", 20, "Male");
    	Driver d2 = new NormalDriver(new Vehicle(new Point(30,0), 250, this.road, 30, 50, 2, "green-sports-car.png"), "Louise", 26, "Female");
    	Driver d3 = new AggressiveDriver(new Vehicle(new Point(0,0), 500, this.road, 30, 50, 3, "pink-sports-car.png"), "Russell", 20, "Male");
